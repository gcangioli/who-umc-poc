...
* description = "The Demp API will support only a limited set of resources and operations on those to fullfill specific use cases"
* kind = #capability
...
* rest.resource[=].searchParam[=].definition = "https://umc-ext-dev-phponfhirdemo-preview-rg01-webapp.azurewebsites.net/SearchParameter/parentphp"
* rest.resource[=].searchParam[=].type = #string
